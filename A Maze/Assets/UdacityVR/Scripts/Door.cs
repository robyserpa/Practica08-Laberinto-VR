...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        leftDoorEndRotation = Quaternion.Euler(leftDoor.transform.rotation.eulerAngles.x, leftDoor.transform.rotation.eulerAngles.y, -90f);
        ...
        rightDoorEndRotation = Quaternion.Euler(rightDoor.transform.rotation.eulerAngles.x, rightDoor.transform.rotation.eulerAngles.y, 90f);
	...
	void Update () {
        ...
        if (opening){
            ...
            leftDoor.transform.Rotate(0f, 0f, Time.deltaTime);
            rightDoor.transform.Rotate(0f, 0f, Time.deltaTime);
        }
    }
